...
from configuration import HEBREW_STOP_WORDS
...
def plot_most_common_words():
    ...
    stop_words = load_stopwords(HEBREW_STOP_WORDS)

    text_processed = remove_stopwords(sentence=text, stopwords=stop_words)

    bidi_text = get_display(text_processed)
    # Create a WordCloud object
    meta_mask = np.array(Image.open(r'C:\Users\Yoni\PycharmProjects\Ynet.png'))
